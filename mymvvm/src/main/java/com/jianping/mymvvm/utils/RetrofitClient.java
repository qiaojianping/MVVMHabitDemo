package com.jianping.mymvvm.utils;
...
public class RetrofitClient {
    ...
    private static class SingletonHolder {
        private static RetrofitClient INSTAANCE = new RetrofitClient();
    }
    ...
    private RetrofitClient(String url, Map<String, String> headers) {
        ...
        if (mHttpCacheDirectory == null) {
            mHttpCacheDirectory = new File(mContext.getCacheDir(), "http_cache");
        }
